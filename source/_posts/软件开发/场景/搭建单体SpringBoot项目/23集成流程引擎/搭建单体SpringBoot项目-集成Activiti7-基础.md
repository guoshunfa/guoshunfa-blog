---
title: 搭建单体SpringBoot项目 集成Activiti7 基础
tags:
 - Activiti7
 - SpringBoot
categories:
...
![img](搭建单体SpringBoot项目-集成Activiti7-基础/clip_image002-1573894539698.jpg)

经历的版本:

![img](搭建单体SpringBoot项目-集成Activiti7-基础/clip_image002-1573894569746.jpg)
...
![img](搭建单体SpringBoot项目-集成Activiti7-基础/clip_image002-1573894913998.jpg)
...
![img](搭建单体SpringBoot项目-集成Activiti7-基础/clip_image002-1573894954565.jpg)

活动用圆角矩形表示，一个流程由一个活动或多个活动组成

![img](搭建单体SpringBoot项目-集成Activiti7-基础/clip_image002-1573894978125.jpg)
...
![](搭建单体SpringBoot项目-集成Activiti7-基础/1572852095.png)



执行完成后我们查看数据库， 创建了 25 张表，结果如下： 

![](搭建单体SpringBoot项目-集成Activiti7-基础/1572852222.png)
...
![img](搭建单体SpringBoot项目-集成Activiti7-基础/clip_image002.jpg)
...
![1574522151044](搭建单体SpringBoot项目-集成Activiti7-基础/1574522151044.png)

### 活动 Activity

活动是工作或任务的一个通用术语。一个活动可以是一个任务，还可以是一个当前流程的子处理流程； 其次，你还可以为活动指定不同的类型。常见活动如下：

![1574562726375](搭建单体SpringBoot项目-集成Activiti7-基础/1574562726375.png)

### 网关 GateWay

网关用来处理决策，有几种常用网关需要了解：

![1574563600305](搭建单体SpringBoot项目-集成Activiti7-基础/1574563600305.png)
...
![1574563937457](搭建单体SpringBoot项目-集成Activiti7-基础/1574563937457.png)
...
![1575106985823](搭建单体SpringBoot项目-集成Activiti7-基础/1575106985823.png)

弹出如下图所示框，输入evection 表示 出差审批流程：

![1575107231004](搭建单体SpringBoot项目-集成Activiti7-基础/1575107231004.png)

起完名字evection后（默认扩展名为bpmn），就可以看到流程设计页面，如图所示：

![1575107336431](搭建单体SpringBoot项目-集成Activiti7-基础/1575107336431.png)
...
![1575107648105](搭建单体SpringBoot项目-集成Activiti7-基础/1575107648105.png)

### 指定流程定义Key

流程定义key即流程定义的标识，通过properties视图查看流程的key

![1575115474865](搭建单体SpringBoot项目-集成Activiti7-基础/1575115474865.png)
...
![1575108966935](搭建单体SpringBoot项目-集成Activiti7-基础/1575108966935.png)
...
![1575109268443](搭建单体SpringBoot项目-集成Activiti7-基础/1575109268443.png)
...
![1575109366989](搭建单体SpringBoot项目-集成Activiti7-基础/1575109366989.png)

#### 4、解决中文乱码

1、打开Settings，找到File Encodings，把encoding的选项都选择UTF-8

![1575112075626](搭建单体SpringBoot项目-集成Activiti7-基础/1575112075626.png)

2、打开IDEA安装路径，找到如下的安装目录

![1575109627745](搭建单体SpringBoot项目-集成Activiti7-基础/1575109627745.png)

根据自己所安装的版本来决定，我使用的是64位的idea，所以在idea64.exe.vmoptions文件的最后一行追加一条命令： -Dfile.encoding=UTF-8 

如下所示：

![https://images2017.cnblogs.com/blog/963440/201712/963440-20171221132445475-1259807908.png](搭建单体SpringBoot项目-集成Activiti7-基础/clip_image002.png)

一定注意，不要有空格，否则重启IDEA时会打不开，然后 重启IDEA。

如果以上方法已经做完，还出现乱码，就再修改一个文件，并在文件的末尾添加： -Dfile.encoding=UTF-8，然后重启idea，如图：

![1575113551947](搭建单体SpringBoot项目-集成Activiti7-基础/1575113551947.png)

最后重新在evection.xml文件上面，点右键并选择Diagrams菜单，再选择Show BPMN2.0 Designer…，看到生成图片，如图：

![1575113951966](搭建单体SpringBoot项目-集成Activiti7-基础/1575113951966.png)
...
![1575114245068](搭建单体SpringBoot项目-集成Activiti7-基础/1575114245068.png)
...
![1575116732147](搭建单体SpringBoot项目-集成Activiti7-基础/1575116732147.png)
...
![1575116797665](搭建单体SpringBoot项目-集成Activiti7-基础/1575116797665.png)
...
![1575116832196](搭建单体SpringBoot项目-集成Activiti7-基础/1575116832196.png)
...
![1575117588624](搭建单体SpringBoot项目-集成Activiti7-基础/1575117588624.png)
